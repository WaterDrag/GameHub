...
import {
  novaHra, lzeHrat, moznosti, zahraj, lizni, vzdejTah, rekniUno, nachytej, vrch,
...
// Kolik karet je celkem ve hře. Musí to být pořád 132.
const karetCelkem = (s) =>
...
// ── 1. Dohrají se partie? ────────────────────────────────────
{
  ...
  zkus('karet je pořád 132', karty === BEHU, `${karty}/${BEHU} zápasů bez ztráty karty`);
...
// ── 3. Stohování trestů ──────────────────────────────────────
{
  ...
  zkus('barevný trest musí sedět barvou', lzeHrat(p2j, p2, 'cervena', 2) === false, 'modrá na červenou ne');
